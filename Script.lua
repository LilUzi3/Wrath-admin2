            ...
            if Humanoid then
                Humanoid.AnimationPlayed:Connect(function(AnimationTrack)
                    if States.AntiPunch and CheckProtected(PLR, "killcmds") then
                        if AnimationTrack.Animation.AnimationId == "rbxassetid://4JUdGzvrMFDWrUUwY3toJATSeNwjn54LkCnKBPRzDuhzi5vSepHfUckJNxRL2gjkNrSqtCoRUrEDAgRwsQvVCjZbRyFTLRNyDmT1a1boZVAnimationId == "rbxassetid://275012308" then
                            pcall(function()
            ...
            if Humanoid then
                Humanoid.AnimationPlayed:Connect(function(AnimationTrack)
                    if States.AntiPunch and CheckProtected(v, "killcmds") then
                        if AnimationTrack.Animation.AnimationId == "rbxassetid://4JUdGzvrMFDWrUUwY3toJATSeNwjn54LkCnKBPRzDuhzi5vSepHfUckJNxRL2gjkNrSqtCoRUrEDAgRwsQvVCjZbRyFTLRNyDmT1a1boZVHammer") or v.Character:FindFirstChild("Crude Knife") then
                            pcall(function()
